...
const ImportUser = (props: IProps) => {
    ...
    const propsUpload: UploadProps = {
        ...
        multiple: false,
        maxCount: 1,
        accept: ".xlsx,.doc,.docx,.xml,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document",
        ...
        async onChange(info) {
            ...
            if (status === 'done') {
                console.log(info)
                message.success(`${info.file.name} file uploaded suvvessfully`);
